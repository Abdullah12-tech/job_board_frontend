...
const AdminSidebar = () => {
  ...
  return (
    <div className="w-64 bg-gray-800 text-white flex-1 flex flex-col min-h-0 overflow-y-auto">
      ...
      <div className="p-4 border-t border-gray-700">
        <button onClick={handleLogout} className="flex items-center w-full p-3 rounded-lg hover:bg-gray-700">
